    ...
    <div name='home' className='flex w-full h-screen justify-center bg-[#ffffff] pt-[80px]'>
      ...
      <div className='flex flex-col-reverse h-full items-start sm:flex-row max-w-[1000px] justify-center sm:items-center'> 
        ...
        <div className='w-full sm:w-8/12 px-8 sm:pl-18 sm:pr-0 mx-auto flex flex-col justify-center h-fit sm:h-full font-mono text-[#5e5e5e]'>
          ...
          <h1 className='text-4xl sm:text-5xl font-bold font-display py-4'>Christina Lu</h1>
          <h2 className='text-1xl sm:text-2xl font-bold'>I'm a Fullstack Developer.</h2>
          <div className='py-4'>

            {/* view my work button */}
            <button className='text-[#5e5e5e] text-xs group border px-6 py-3 my-2 flex items-center hover:bg-[#5e5e5e] hover:text-white hover:border-transparent rounded transition ease-in-out duration-300'>
              View My Work 
        ...
        {/* headshot */}
        <div className='px-8 w-3/4 sm:w-[350px] max-w-[300px] '>
