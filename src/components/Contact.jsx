  ...
  return (
    <div name='contact' className='w-full h-fit flex flex-col justify-center items-center p-4 pt-16 font-mono text-[#5e5e5e]'>
        ...
        <form action='https://getform.io/f/e1d0dccd-6278-4cf3-b445-eaa4cc127c68' className='flex flex-col max-w-[500px] w-full text-xs' method='POST'>
            ...
            <input className='p-2 border rounded outline-none' type="text" placeholder='Name' name='name' />
            <input className='my-4 p-2 border rounded outline-none' type="email" placeholder='Email' name='email' />
            <textarea className='p-2 border rounded outline-none resize-none' name="message" rows="10" placeholder='Message'></textarea>
